...
namespace AutoUpdate
{
	...
	public class FrmUpdate : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label4.Text = "立信会计师事务所（特殊普通合伙）";
            // 
            // linkLabel1
            // 
            ...
            this.linkLabel1.Text = "http://www.bdo.com.cn";
...
//			char[] split = @"\".ToCharArray();
		...
		private void btnFinish_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                CopyFile(tempUpdatePath, Application.StartupPath);  
            ...
            Process.Start(Application.StartupPath + @"\" + mainAppExe);
        }
